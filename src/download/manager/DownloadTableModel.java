...
/**
 * This class represents the model of the JTable present in the final GUI.
...
public class DownloadTableModel extends AbstractTableModel implements Observer{
  ...
  ///< All the column names in the JTable in the GUI 

  private static final Class[] columnClasses = {String.class,String.class,JProgressBar.class,String.class};
  ///< which class does each column belong in the JTable

  private ArrayList<Download> downloadList = new ArrayList<>();
  ///< The ArrayList containing the list of currently downloading files in the JTable
  
  /**
   * Add download to the table.
   * @param download The instance of the download
   */
